...
export default async function Home() {
  ...
  return (
    <>
      <section className="h-full w-full md:pt-44 md:mt-[70px] relative flex items-center justify-center flex-col ">
      ...
      <section className="flex justify-center items-center flex-col gap-4 md:!mt-20 mt-0">
